                    ...
                    {!helper ? <>
                        <form noValidate onSubmit={sendOTPHandler}>
                            <div className="form-group">
                                ...
                                <small id="emailHelp" className="form-text text-muted">Нэг удаагийн нууц үгийн хүчинтэй хугацаа 5мин </small>
                                {errors.email && (
                            ...
                            {!isLoading && <button type="submit" className="btn btn-info btn-block">Нэг удаагийн нууц үг авах</button>}
                            {/* <button type="submit" className="btn btn-primary">Send OTP</button> */}
                        </form>
                    </> : <>
                            <form noValidate onSubmit={submitOTPHandler}>
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail1">Нэг удаагийн нууц үг</label>
                                ...
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail2">Шинэ нууц үг</label>
                                ...
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail3">Шинэ нууц үг давтах</label>
