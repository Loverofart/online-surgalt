                        ...
                        <div className="col-md-4 m-auto">
                            <form noValidate onSubmit={formHandler}>
                                <div className="form-group">
                                    <label htmlFor="emailId">Хуучин нууц үг</label>
                                ...
                                <div className="form-group">
                                    <label htmlFor="passwordId">Шинэ нууц үг</label>
                                ...
                                <div className="form-group">
                                    <label htmlFor="passwordCId">Шинэ нууц үг давтах</label>
                                ...
                                <button type="submit" class="btn btn-info btn-block ">Нууц үг шинэчлэх</button>
                            </form>
                        </div>
                    </div>
                </div>
